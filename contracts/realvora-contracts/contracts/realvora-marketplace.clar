...
(define-public (create-buy-order 
  ...
  (let (
    ...
    (unwrap! (match-buy-order order-id) ERR_INVALID_AMOUNT)
...
(define-public (create-sell-order
  ...
  (let (
    ...
    (unwrap! (match-sell-order order-id) ERR_INVALID_AMOUNT)
...
(define-public (execute-trade
  ...
  (let (
    ...
    (let (
      ...
      (unwrap! (update-property-price (get property-id buy-order) trade-price trade-value) ERR_INVALID_AMOUNT)
